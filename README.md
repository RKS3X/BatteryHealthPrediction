...
> **อัปเดตล่าสุด:** เปลี่ยนโมเดลที่ใช้จริงจาก SVR เป็น **Random Forest** ตามที่เรียนในคลาส
> (ผลลัพธ์ใกล้เคียงกันมาก R² = 0.969 vs 0.970) — เปรียบเทียบเหลือ 4 โมเดล: Random Forest, Decision Tree,
